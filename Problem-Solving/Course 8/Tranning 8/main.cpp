...
void showTransactionMainMenuScreen()
{
    system("clear");
    cout << "================================================" << endl;
    cout << "\t\tTransation Menue Screen" << endl;
    cout << "================================================" << endl;
    cout << "\t[1] Deposit." << endl;
...
{   
    char answer;
    cout << "Are you sureyou want to perform this transaction? Y/N: ";
    cin >> answer;
    return (answer == 'y' || answer == 'Y');
}
...
bool updateClientBalanceByAccountNumber(string accountNumber, double amount, vector<sClientInfo> &vClients)
{
    for(sClientInfo &C : vClients)
    {
        if(C.accountNumber == accountNumber)
        {
            ...
            saveClientsToFile(FILE_NAME, vClients);
            cout << "\nOne Succesfully, New Balance is: " << C.accountBalance;
            return true;
        }
    }
    return false;
...
void printAllClientsDataWithTotalBalances(vector<sClientInfo> &vClients)
{
    ...
    cout << "\n_______________________________________________________";
    cout << "_________________________________________\n" << endl;
    cout << "\t\t\t\t\t   Total Balences = " << left << setw(12) << totalBalances; 
}
...
void withDrawProcess()
{
    ...
    do
    {
        ...
        cin >> withdrawAmount;
        Found = IsWithDrawGraeterThanAmount(accountNumber, withdrawAmount, vClients);
        if(!Found)
        {
