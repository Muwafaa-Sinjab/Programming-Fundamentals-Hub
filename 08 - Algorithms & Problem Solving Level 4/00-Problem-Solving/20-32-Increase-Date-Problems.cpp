...
bool IsLastDayInMonth(sDate d)
{
    return d.day == GetNumberOfDaysInMonth(d.year, d.month);
}
...
sDate IncreaseDateByXDays(short x, sDate &d)
{
    for (int i = 0; i < x; i++)
...
{
    return IncreaseDateByXDays(7, d);
}

sDate IncreaseDateByXWeeks(short x, sDate &d)
{
    return IncreaseDateByXDays(x * 7, d);
}
...
sDate IncreaseDateByXMonths(short x, sDate &d)
{
    for (int i = 0; i < x; i++)
...
sDate IncreaseDateByXYears(short x, sDate &d)
{
    for (int i = 0; i < x; i++)
...
sDate IncreaseDateByOneDecade(sDate &d)
{
    return IncreaseDateByXYearsFaster(10, d);
}

sDate IncreaseDateByXDecades(short x, sDate &d)
{
    return IncreaseDateByXYears(x * 10, d);
}

sDate IncreaseDateByXDecadesFaster(short x, sDate &d)
{
    return IncreaseDateByXYearsFaster(x * 10, d);
}

sDate IncreaseDateByOneCentury(sDate &d)
{
    return IncreaseDateByXYearsFaster(100, d);
}

sDate IncreaseDateByOneMillennium(sDate &d)
{
    return IncreaseDateByXYearsFaster(1000, d);
}